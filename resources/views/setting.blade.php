                        ...
                        <form id="caseNumberForm" method="POST" action="/case-format">
                            ...
                            <div id="prefixDateDetails" class="mb-4 hidden">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div>
                                        <input type="checkbox" id="prefixDayOnly" name="prefix_day_only" value="1"
                                            class="mr-1">
                            ...
                            <div class="mb-4">
                                ...
                                <div id="autoNumberDetails" class="mt-2 hidden">
                                    ...
                                    <input type="number" id="starterNumber" name="starter_number" min="0"
                                        class="block w-full px-3 py-2 border rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                </div>
                            </div>
                            <div class="mb-4">
                    ...
                    <script>
                        document.getElementById("prefix").addEventListener("change", function() {
                            ...
                            if (this.value === "string") {
                                prefixDetails.classList.remove("hidden");
                                prefixDateDetails.classList.add("hidden");
                            } else if (this.value === "date") {
                                prefixDetails.classList.add("hidden");
                                prefixDateDetails.classList.remove("hidden");
                            } else {
                                prefixDetails.classList.add("hidden");
                                prefixDateDetails.classList.add("hidden");
                            }
                        ...
                        document.getElementById("suffix").addEventListener("change", function() {
                            ...
                            if (this.value === "string") {
                                suffixDetails.classList.remove("hidden");
                                suffixDateDetails.classList.add("hidden");
                            } else if (this.value === "date") {
                                suffixDetails.classList.add("hidden");
                                suffixDateDetails.classList.remove("hidden");
                            } else {
                                suffixDetails.classList.add("hidden");
                                suffixDateDetails.classList.add("hidden");
                            }
                        ...
                        document.getElementById("autoNumber").addEventListener("change", function() {
                            ...
                            if (this.checked) {
                                autoNumberDetails.classList.remove("hidden");
                            } else {
                                autoNumberDetails.classList.add("hidden");
                            }
                        });
